    ...
    <div className="space-y-8">
      ...
      <Tabs defaultValue="services" className="w-full">
        ...
        <TabsContent value="services" className="space-y-6 mt-6">
          ...
          <Card className="p-6">
            <h3 className="text-lg font-medium mb-6">Статусы обновляются автоматически из Grafana</h3>
            <div className="text-sm text-muted-foreground space-y-2">
              <p>✓ Статусы серверов автоматически синхронизируются с Grafana каждые 30 секунд</p>
              <p>✓ Серые бейджи "Load" означают, что данные загружаются или Grafana временно недоступна</p>
              <p>✓ Зеленые "Operational" - сервер работает</p>
              <p>✓ Красные "Down" - сервер не отвечает</p>
            </div>
          </Card>
        </TabsContent>
